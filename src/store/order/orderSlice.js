...
import { calcCount, calcTotalPrice } from "../../utils/calcTotal";
  ...
  reducers: {
    addProduct: (state, action) => {
      ...
      if (productOrderList) {
        ...
        // [state.totalCount, state.totalPrice] = calc
        state.totalCount = calcCount(state.orderGoods);
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(orderRequestAsync.fulfilled, (state, action) => {
        ...
        state.totalCount = calcCount(orderGoods);
